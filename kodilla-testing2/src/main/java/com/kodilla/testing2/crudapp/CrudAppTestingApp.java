...
public class CrudAppTestingApp{
    ...
    public static final String XPATH_SELECT = "//div[contains(@class, \"datatable__tasks-container\")]/form/div/fieldset[2]/select[1]";

    public static void main(String[] args) {
        WebDriver driver = WebDriverConfig.getDriver(WebDriverConfig.CHROME);
        driver.get("https://michalswig.github.io/");
